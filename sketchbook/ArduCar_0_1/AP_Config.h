...
#define GCS_PROTOCOL 	-1		// 0 = Standard ArduPilot (LabVIEW/HappyKillmore), 
...
#define CH3_MIN 1110 			// (Microseconds) Range of Ailerons/ Rudder
#define CH3_MAX 1920 			// (Microseconds)
...
#define THROTTLE_CRUISE 20    	// (0-100) Default throttle value - Used for central value.
#define THROTTLE_MAX 100   	    // (0-100) example: 70 = 56% throttle (lower this if your plane is overpowered)
...
#define USE_AUTO_LAUNCH 1		// If set to 1 then in AUTO mode roll will be held to zero and pitch to TAKE_OFF_PITCH until TAKE_OFF_ALT is reached
...
#define USE_AUTO_LAND 1				// If set to 1 Last waypoint will be the landing target. Set altitude to 0 for last WP
