...
void debug_subsystem()
{
	...
	Serial.print(radio_min[CH_STEERING],DEC);
	Serial.print(" radio_trim ch1: ");
	Serial.print(radio_trim[CH_STEERING],DEC);
	Serial.print(" radio_max ch1: ");
	Serial.println(radio_max[CH_STEERING],DEC);

	Serial.print("radio_min ch2: ");
	Serial.print(radio_min[CH_THROTTLE_R],DEC);
	Serial.print(" radio_trim ch2: ");
	Serial.print(radio_trim[CH_THROTTLE_R],DEC);
	Serial.print(" radio_max ch2: ");
	Serial.println(radio_max[CH_THROTTLE_R],DEC);
	...
	Serial.print(radio_min[CH_UNUSED],DEC);
	Serial.print(" radio_trim ch4: ");
	Serial.print(radio_trim[CH_UNUSED],DEC);
	Serial.print(" radio_max ch4: ");
	Serial.println(radio_max[CH_UNUSED],DEC);
	*/
	while(1){
		delay(20);
		// Filters radio input - adjust filters in the radio.pde file
		// ----------------------------------------------------------
		read_radio();
		servo_out[CH_STEERING]  = (float)((radio_in[CH_STEERING]  - radio_trim[CH_STEERING]) * 45  * REVERSE_ROLL) / 500;
		servo_out[CH_THROTTLE_R] = (float)((radio_in[CH_THROTTLE_R] - radio_trim[CH_THROTTLE_R]) * 45 * REVERSE_PITCH) / 500;
		servo_out[CH_UNUSED] = (float)((radio_in[CH_UNUSED] - radio_trim[CH_UNUSED]) * 45 * REVERSE_RUDDER) / 500;
		...
		Serial.print(servo_out[CH_STEERING],DEC);
		Serial.print("\tch2: ");
		Serial.print(servo_out[CH_THROTTLE_R],DEC);
		Serial.print("\tch3: ");
		Serial.print(servo_out[CH_THROTTLE],DEC);
		Serial.print("\tch4: ");
		Serial.print(servo_out[CH_UNUSED],DEC);

		Serial.print("\tRadio out ch1: ");
		Serial.print(radio_out[CH_STEERING],DEC);
		Serial.print("\tch2: ");
		Serial.print(radio_out[CH_THROTTLE_R],DEC);
		Serial.print("\tch3:");
		Serial.print(radio_out[CH_THROTTLE],DEC);
		Serial.print("\tch4:");
		Serial.println(radio_out[CH_UNUSED],DEC);
		//*/
	}
}
#endif
